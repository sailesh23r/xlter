...
export default function LeadGenSection({
  ...
  description = "Join the elite studios who have transformed their digital presence with Xeltr. Let's build something legendary together.",
  whatsappNumber = "+91XXXXXXXXXX",
  phoneNumber = "+91XXXXXXXXXX",
  email = "contact@xeltr.com",
}: LeadGenSectionProps) {
  return (
    <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto">
        <div className="bg-[#111111] border border-white/10 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-16 lg:p-24 relative overflow-hidden group">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <motion.span
                ...
                viewport={{ once: true }}
                className="text-primary font-black uppercase tracking-[0.4em] text-[10px] mb-8 block relative"
              >
                Let&apos;s Talk
              </motion.span>
              <motion.h2
                ...
                className="text-3xl sm:text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.95] text-white mb-8 relative"
              >
                {title}
              </motion.h2>
              <motion.p
                ...
                className="text-muted-foreground text-sm sm:text-base md:text-lg font-medium max-w-xl leading-relaxed mb-12 relative"
              >
                {description}
              </motion.p>
              ...
              <motion.div
                ...
                className="flex flex-wrap gap-4 sm:gap-6 relative"
              >
                <Link
                  href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <motion.a
                ...
                className="p-8 bg-white/2 border border-white/5 rounded-3xl hover:border-primary/30 transition-all group/card relative"
              >
      ...
      <div className="absolute -bottom-1/2 -right-1/4 w-[800px] max-w-full h-[800px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
    </section>
  );
}
