...
export default function WhatsAppButton() {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[40] bg-[#25D366] text-white p-2.5 md:p-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.3)] flex items-center justify-center group"
        >
