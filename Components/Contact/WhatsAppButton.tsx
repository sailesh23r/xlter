...
export default function WhatsAppButton() {
    ...
    const message = "Hello Xeltr! I'm interested in your digital services.";
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            aria-label="Contact Xeltr on WhatsApp"
            className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-4 z-40 sm:bottom-6 sm:right-6 h-14 w-14 sm:h-16 sm:w-16 bg-[#25D366] text-white rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.3)] flex items-center justify-center group"
        >
