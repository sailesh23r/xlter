      ...
      <AnimatePresence>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8 space-y-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-[#020617] border border-white/10 rounded-3xl overflow-hidden">
          ...
          <div className="lg:col-span-4 space-y-4">
             ...
             {loading ? (
                 ...
                 <div className="space-y-3">
                    {pages.map((p) => (
                        <div key={p._id} className="group bg-[#020617] border border-white/10 rounded-2xl p-4 flex items-center justify-between hover:border-primary/30 transition-all">
                            <div>
